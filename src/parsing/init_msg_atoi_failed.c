...
static int	msg_atoi_wrong_input(char **ptr_str_err_msg, char *input);
static int	msg_atoi_overflow_underflow(char **ptr_str_err_msg, char *input);
static int	msg_atoi_too_large_input(char **ptr_str_err_msg, char *input);
		...
		int ret, char *input)
{
	...
	{
		return (msg_atoi_too_large_input(ptr_str_err_msg, input));
	}
	else if (ret == ATOI_SAFE_OVERFLOW || ret == ATOF_SAFE_UNDERFLOW)
	{
		return (msg_atoi_overflow_underflow(ptr_str_err_msg, input));
	}
	else if (ret == ATOI_SAFE_WRONG_INPUT)
	{
		return (msg_atoi_wrong_input(ptr_str_err_msg, input));
	}
